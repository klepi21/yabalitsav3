  ...
  return (
    <section id="features" className="py-32 w-full relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative z-10">
          {/* Feature 1 */}
          <div className="group bg-white/5 border border-white/10 hover:border-emerald-500/30 p-8 rounded-3xl transition-all duration-300 hover:bg-white/10 hover:shadow-[0_0_30px_-5px_rgba(116,238,22,0.1)]">
