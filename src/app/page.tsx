  ...
  return (
    <div className="relative min-h-screen w-full bg-[#040D12] text-white font-sans overflow-hidden flex flex-col selection:bg-emerald-500/30">
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-4 pt-10 pb-32">
        <h1 className="text-[3rem] sm:text-[4.5rem] md:text-[5.5rem] lg:text-[6.5rem] font-medium leading-[1.1] tracking-tight mb-6 mtEmpty">
          <span className="text-zinc-400">Το μέλλον της διαχείρισης</span><br />
          <span className="text-zinc-300 flex items-center justify-center gap-4 flex-wrap mt-2">
            έγινε <span className="font-serif italic lowercase text-white tracking-normal px-2">digital</span> <span className="font-black text-emerald-400 shadow-emerald-400/50 drop-shadow-xl">+ Yabalitsa</span>
          </span>
        </h1>
        ...
        >
          <span className="relative z-10">Μπείτε στη Νέα Εποχή</span>
        </Link>
      </main>
    </div>
  );
