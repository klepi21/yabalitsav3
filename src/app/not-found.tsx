  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 via-white to-gray-100 px-4 py-12">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-10 right-10 w-72 h-72 bg-emerald-600 opacity-5 rounded-full blur-3xl"></div>
      ...
      <div className="relative z-10 text-center max-w-2xl">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative">
            <div className="text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-green-600 mb-4">
              404
            </div>
        ...
        <div className="mb-6">
          ...
          <div className="h-1.5 w-32 bg-gradient-to-r from-emerald-600 to-green-500 mx-auto rounded-full"></div>
        </div>
        ...
        <div className="text-sm text-gray-600">
          ...
          <p className="text-xs text-gray-500">
            Error: <span className="font-mono font-bold text-emerald-600">404_NOT_FOUND</span>
          </p>
        </div>
      </div>
    </div>
