        ...
        <div className="px-4 py-4 sm:px-6">
          <Breadcrumb className="mb-2">
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink asChild>
                  <Link href="/management/academy/user-groups">Κατηγορίες</Link>
                </BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator />
              <BreadcrumbItem>
                <BreadcrumbPage>Νέα Κατηγορία</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-foreground">Νέα Κατηγορία Χρηστών</h1>
              <p className="text-sm text-muted-foreground">Δημιουργήστε μια νέα κατηγορία με δυναμικά πεδία</p>
            </div>
          </div>
        </div>
      </div>
