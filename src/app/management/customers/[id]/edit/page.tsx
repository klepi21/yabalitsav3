  ...
  if (error && !customer) {
    return (
      <div className="text-center py-16">
        ...
        <h3 className="text-lg font-semibold tracking-tight text-zinc-900">{error}</h3>
        ...
        <CardContent className="p-5 sm:p-8">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 sm:space-y-8">
            ...
            <div className="space-y-2">
              <Label htmlFor="name" className="text-xs font-semibold text-zinc-500 ml-0.5 flex items-center gap-2">
            ...
            {/* Phone */}
            <div className="space-y-2">
              <Label htmlFor="phone" className="text-xs font-semibold text-zinc-500 ml-0.5 flex items-center gap-2">
              ...
              />
              {errors.phone && (
                <p className="text-xs font-medium text-red-500 ml-1">{errors.phone.message}</p>
              )}
            </div>

            {/* Email */}
            <div className="space-y-2">
              <Label htmlFor="email" className="text-xs font-semibold text-zinc-500 ml-0.5 flex items-center gap-2">
            ...
            <div className="rounded-xl bg-zinc-50 p-4 space-y-2">
              <p className="text-2xs font-semibold text-zinc-500">Πληροφορίες Συστήματος</p>
              <div className="flex flex-wrap gap-x-6 gap-y-1 text-xs font-medium text-zinc-500">
            ...
            <div className="flex flex-col-reverse sm:flex-row items-stretch sm:items-center justify-end gap-3 pt-2">
              ...
              <Button
                type="submit"
                disabled={isSaving}
                className="h-11 sm:h-12 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-semibold shadow-lg shadow-emerald-200 transition-all active:scale-[0.98]"
              >
                {isSaving ? (
